<h2><a href="https://leetcode.com/problems/remove-nodes-from-linked-list/solution/">2487. Remove Nodes From Linked List</a></h2><h3>Medium</h3><hr><div><p>You are given the <code>head</code> of a linked list.</p>
